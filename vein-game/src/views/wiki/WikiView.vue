      ...
      <div class="container">
        ...
        <div class="features-grid">
          <div class="feature-card">
            ...
            <p>
              {{ $t('wikiPage.whyChoose.features.knowledge.content') }} <a :href="getLocalizedPath('/vein-wiki/mechanics')" class="inline-link">{{ $t('wikiPage.whyChoose.features.knowledge.link') }}</a> {{ $t('wikiPage.whyChoose.features.knowledge.content2') }}
            </p>
          </div>
          <div class="feature-card">
            <div class="feature-icon">🎮</div>
            ...
            <p>
              {{ $t('wikiPage.whyChoose.features.mechanics.content') }} <a :href="getLocalizedPath('/vein-wiki/mechanics')" class="inline-link">{{ $t('wikiPage.whyChoose.features.mechanics.link') }}</a> {{ $t('wikiPage.whyChoose.features.mechanics.content2') }}
            </p>
          </div>
          <div class="feature-card">
            ...
            <p>
              {{ $t('wikiPage.whyChoose.features.skills.content') }} <a :href="getLocalizedPath('/vein-wiki/skills')" class="inline-link">{{ $t('wikiPage.whyChoose.features.skills.link') }}</a> {{ $t('wikiPage.whyChoose.features.skills.content2') }}
            </p>
          </div>
          <div class="feature-card">
            <div class="feature-icon">🏗️</div>
            ...
            <p>
              {{ $t('wikiPage.whyChoose.features.building.content') }} <a :href="getLocalizedPath('/vein-wiki/building')" class="inline-link">{{ $t('wikiPage.whyChoose.features.building.link') }}</a> {{ $t('wikiPage.whyChoose.features.building.content2') }}
            </p>
          </div>
          <div class="feature-card">
            <div class="feature-icon">🚗</div>
            ...
            <p>
              {{ $t('wikiPage.whyChoose.features.vehicles.content') }} <a :href="getLocalizedPath('/vein-wiki/vehicles')" class="inline-link">{{ $t('wikiPage.whyChoose.features.vehicles.link') }}</a> {{ $t('wikiPage.whyChoose.features.vehicles.content2') }}
            </p>
          </div>
          <div class="feature-card">
            <div class="feature-icon">🍳</div>
      ...
      <div class="container">
        ...
        <div class="faq-grid">
          ...
          <article class="faq-item">
            ...
            <p>
              {{ $t('wikiPage.faq.items.controls.answer1') }} <a :href="getLocalizedPath('/vein-wiki/controls')" class="inline-link">{{ $t('wikiPage.faq.items.controls.link') }}</a> {{ $t('wikiPage.faq.items.controls.answer2') }}
            </p>
            <p>
          ...
          <article class="faq-item">
            ...
            <p>
              {{ $t('wikiPage.faq.items.skills.answer1') }} <a :href="getLocalizedPath('/vein-wiki/skills')" class="inline-link">{{ $t('wikiPage.faq.items.skills.link') }}</a> {{ $t('wikiPage.faq.items.skills.answer2') }}
            </p>
            <p>
          ...
          <article class="faq-item">
            ...
            <p>
              {{ $t('wikiPage.faq.items.recipes.answer1') }} <a :href="getLocalizedPath('/vein-wiki/cooking-recipes')" class="inline-link">{{ $t('wikiPage.faq.items.recipes.link') }}</a> {{ $t('wikiPage.faq.items.recipes.answer2') }}
            </p>
            <p>
