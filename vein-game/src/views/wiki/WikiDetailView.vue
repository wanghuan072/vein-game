    ...
    <section class="wiki-detail-header" v-if="wiki">
      <div class="container">
        <div class="breadcrumb">
          <a :href="getLocalizedPath('/vein-wiki')" class="breadcrumb-link">
            <svg
            ...
            <div class="wiki-navigation" v-if="otherWikis && otherWikis.length > 0">
              ...
              <div class="nav-grid">
                <a
                  ...
                  :key="item.id"
                  :href="getLocalizedPath(`/vein-wiki${item.addressBar}`)"
                  class="nav-card"
                >
    ...
    <section class="wiki-content" v-else>
      <div class="container">
        <div class="not-found">
          ...
          <a :href="getLocalizedPath('/vein-wiki')" class="btn-hero btn-secondary">{{
            $t('wikiDetailPage.notFound.back')
          }}</a>
        </div>
      </div>
    </section>
