  ...
  <div class="home-view">
    <main>
          ...
          <div class="hero-content">
            <div class="hero-text">
              ...
              <div class="hero-actions">
                <a
                  :href="getLocalizedPath('/vein-map')"
                  class="btn-hero btn-steam"
                >
                  <span>{{ $t('homePage.hero.button1') }}</span>
                </a>
                <a :href="getLocalizedPath('/vein-guides')" class="btn-hero btn-secondary">{{ $t('homePage.hero.button2') }}</a>
              </div>
        ...
        <div class="container">
          ...
          <div class="what-is-content">
            ...
            <div class="what-is-text">
              ...
              <p>
                {{ $t('homePage.whatIs.scavenging.content1') }} <a :href="getLocalizedPath('/vein-guides/vein-best-loot-locations')" class="inline-link">{{ $t('homePage.whatIs.scavenging.link1') }}</a> {{ $t('homePage.whatIs.scavenging.content2') }}
              </p>
              <p>
                {{ $t('homePage.whatIs.scavenging.content3') }} <a :href="getLocalizedPath('/vein-wiki/controls')" class="inline-link">{{ $t('homePage.whatIs.scavenging.link2') }}</a> {{ $t('homePage.whatIs.scavenging.content4') }}
              </p>
            </div>
          </div>
          <div class="what-is-content reverse">
            ...
            <div class="what-is-text">
              ...
              <p>
                {{ $t('homePage.whatIs.dynamic.content1') }} <a :href="getLocalizedPath('/vein-wiki/mechanics')" class="inline-link">{{ $t('homePage.whatIs.dynamic.link1') }}</a> {{ $t('homePage.whatIs.dynamic.content2') }}
              </p>
              <p>
        ...
        <div class="container">
          ...
          <div class="guides-grid">
            <a
              ...
              :key="guide.id"
              :href="getLocalizedPath(`/vein-guides${guide.addressBar ? (guide.addressBar.startsWith('/') ? guide.addressBar : '/' + guide.addressBar) : ''}`)"
              class="guide-card"
            >
          ...
          <div class="guides-actions" v-if="homeGuides.length > 0">
            <a :href="getLocalizedPath('/vein-guides')" class="btn-hero btn-secondary">{{ $t('homePage.guides.viewAll') }}</a>
          </div>
        </div>
      </section>
      ...
      <section class="map-section">
        <div class="container">
          <h2 class="section-title">{{ $t('homePage.map.title') || 'VEIN Interactive Map' }}</h2>
          <p class="section-subtitle">
            {{ $t('homePage.map.subtitle') || 'Explore the complete VEIN game map with detailed locations, routes, and points of interest. Our comprehensive VEIN interactive map is the most accurate map available online.' }}
          </p>
          <div class="map-card">
            <div class="map-card-content">
              <h3>{{ $t('homePage.map.card.title') || 'Complete VEIN Game Map' }}</h3>
              <p>{{ $t('homePage.map.card.description') || 'Navigate through the entire Champlain Valley region with our detailed interactive map. Find all locations, landmarks, and points of interest on the most comprehensive VEIN game map available.' }}</p>
              <ul class="map-features">
                <li>{{ $t('homePage.map.features.zoom') || 'Zoom and pan functionality' }}</li>
                <li>{{ $t('homePage.map.features.poi') || 'All 154 Points of Interest marked' }}</li>
                <li>{{ $t('homePage.map.features.towns') || 'Complete town and settlement maps' }}</li>
                <li>{{ $t('homePage.map.features.realTime') || 'Real-time location tracking' }}</li>
              </ul>
              <div class="map-actions">
                <a :href="getLocalizedPath('/vein-map-detail')" class="btn-hero btn-steam">
                  {{ $t('homePage.map.button') || 'View Interactive Map' }}
                </a>
                <a :href="getLocalizedPath('/vein-map')" class="btn-hero btn-secondary">
                  {{ $t('homePage.map.button2') || 'Map Guide' }}
                </a>
              </div>
            </div>
            <div class="map-card-image">
              <div class="map-preview">
                <img src="/images/map-img.webp" alt="VEIN Interactive Map" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="faq-grid">
            ...
            <article class="faq-item">
              ...
              <p>
                {{ $t('homePage.faq.items.different.answer1') }} <a :href="getLocalizedPath('/vein-wiki/mechanics')" class="inline-link">{{ $t('homePage.faq.items.different.link') }}</a> {{ $t('homePage.faq.items.different.answer2') }}
              </p>
            </article>
            <article class="faq-item">
              <h3>{{ $t('homePage.faq.items.multiplayer.question') }}</h3>
              <p>
                {{ $t('homePage.faq.items.multiplayer.answer1') }} <a :href="getLocalizedPath('/vein-guides')" class="inline-link">{{ $t('homePage.faq.items.multiplayer.link') }}</a>{{ $t('homePage.faq.items.multiplayer.answer2') }}
              </p>
            </article>
            <article class="faq-item">
...
.map-card:hover {
  border-color: rgba(255, 54, 54, 0.4);
  box-shadow: 0 25px 60px rgba(255, 54, 54, 0.2);
  transform: translateY(-4px);
}
