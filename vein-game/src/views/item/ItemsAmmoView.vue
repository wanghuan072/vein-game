    ...
    <div class="container">
      <div class="page-header">
        ...
        <p class="page-subtitle">
          Ammunition calibers and special rounds tailored for every firearm platform in VEIN
          survival game.
        </p>
      </div>
...
const roundsItems = computed(() => {
  ...
  if (import.meta.env.DEV) {
    console.log(
      `[ItemsAmmoView] roundsItems - lang: ${currentLang}, targetType: "${targetType}", count: ${
        filtered.length
...
onMounted(async () => {
  ...
  if (import.meta.env.DEV) {
    console.log(
      `[ItemsAmmoView] onMounted - locale.value: ${locale.value}, getCurrentLocale(): ${currentLang}`
    )
  }
