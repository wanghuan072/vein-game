    ...
    <section class="detail-header-section" v-if="item">
      <div class="container">
        <div class="breadcrumb">
          <a :href="getLocalizedPath('/vein-items')" class="breadcrumb-link">
          ...
          <a :href="getLocalizedPath(`/vein-items/${category}`)" class="breadcrumb-link">{{ categoryTitle }}</a>
          <svg class="breadcrumb-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <polyline points="9,18 15,12 9,6" />
          </svg>
            ...
            <div class="nav-box" v-if="otherItems.length > 0">
              ...
              <div class="nav-links">
                <a
                  ...
                  :key="it.id"
                  :href="getLocalizedPath(`/vein-items/${category}/${(it.addressBar || '').replace('/', '')}`)"
                  class="nav-link"
                >
                  {{ it.title }}
                </a>
    ...
    <section class="items-content" v-else>
      <div class="container">
        <div class="not-found">
          ...
          <a :href="getLocalizedPath(`/vein-items/${category}`)" class="btn-hero btn-secondary">{{ $t('itemsDetailPage.notFound.back') }} {{ categoryTitle }}</a>
        </div>
      </div>
    </section>
  </div>
