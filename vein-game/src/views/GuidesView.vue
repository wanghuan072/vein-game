      ...
      <div class="container">
        ...
        <div class="features-grid">
          <div class="feature-card">
            ...
            <p>
              {{ $t('guidesPage.whyChoose.features.comprehensive.content') }}
              <a :href="getLocalizedPath('/vein-guides/ultimate-world-settings-guide')" class="inline-link">{{
                $t('guidesPage.whyChoose.features.comprehensive.link')
              }}</a>
              {{ $t('guidesPage.whyChoose.features.comprehensive.content2') }}
            </p>
          </div>
          <div class="feature-card">
            <div class="feature-icon">🎯</div>
          ...
          <div class="feature-card">
            ...
            <p>
              {{ $t('guidesPage.whyChoose.features.locations.content') }}
              <a
                :href="getLocalizedPath('/vein-guides/vein-best-base-location-survival-guide')"
                class="inline-link"
                >{{ $t('guidesPage.whyChoose.features.locations.link1') }}</a
              >
              {{ $t('guidesPage.whyChoose.features.locations.content2') }}
              <a :href="getLocalizedPath('/vein-guides/vein-best-loot-locations')" class="inline-link">{{
                $t('guidesPage.whyChoose.features.locations.link2')
              }}</a>
              {{ $t('guidesPage.whyChoose.features.locations.content2') }}
            </p>
          </div>
          <div class="feature-card">
            ...
            <p>
              {{ $t('guidesPage.whyChoose.features.settings.content') }}
              <a :href="getLocalizedPath('/vein-guides/ultimate-world-settings-guide')" class="inline-link">{{
                $t('guidesPage.whyChoose.features.settings.link')
              }}</a>
              {{ $t('guidesPage.whyChoose.features.settings.content2') }}
            </p>
          </div>
          <div class="feature-card">
            <div class="feature-icon">👥</div>
      ...
      <div class="container">
        ...
        <div class="faq-grid">
          ...
          <article class="faq-item">
            ...
            <p>
              {{ $t('guidesPage.faq.items.beginners.answer1') }}
              <a :href="getLocalizedPath('/vein-guides/ultimate-world-settings-guide')" class="inline-link">{{
                $t('guidesPage.faq.items.beginners.link')
              }}</a>
              {{ $t('guidesPage.faq.items.beginners.answer2') }}
            </p>
            <p>
          ...
          <article class="faq-item">
            ...
            <p>
              {{ $t('guidesPage.faq.items.locations.answer1') }}
              <a
                :href="getLocalizedPath('/vein-guides/how-to-find-clinton-correctional-facility-armory')"
                class="inline-link"
                >{{ $t('guidesPage.faq.items.locations.link') }}</a
              >{{ $t('guidesPage.faq.items.locations.answer2') }}
            </p>
            <p>
