    ...
    <section class="search-results-section">
      <div class="container">
        ...
        <div v-else-if="!searchQuery || totalResults === 0" class="no-results">
          ...
          <p v-if="searchQuery">
            {{ $t('searchPage.noResults.content1') }} "{{ searchQuery }}"{{ $t('searchPage.noResults.content2') }} <a :href="getLocalizedPath('/vein-guides')" class="inline-link">{{ $t('searchPage.noResults.link1') }}</a>, <a :href="getLocalizedPath('/vein-wiki')" class="inline-link">{{ $t('searchPage.noResults.link2') }}</a>, {{ $t('searchPage.noResults.content3') }} <a :href="getLocalizedPath('/vein-items')" class="inline-link">{{ $t('searchPage.noResults.link3') }}</a>.
          </p>
          <p v-else>
