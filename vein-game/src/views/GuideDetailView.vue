    ...
    <section class="guide-detail-header" v-if="guide">
      <div class="container">
        <div class="breadcrumb">
          <a :href="getLocalizedPath('/vein-guides')" class="breadcrumb-link">
            <svg
          ...
          <div class="right-sidebar">
            ...
            <div class="guide-navigation" v-if="previousGuide || nextGuide">
              ...
              <div class="nav-grid">
                <a
                  v-if="previousGuide"
                  :href="getLocalizedPath(`/vein-guides${previousGuide.addressBar}`)"
                  class="nav-card nav-card-prev"
                >
                  <div class="nav-card-direction">
                    {{ $t('guideDetailPage.navigation.previous') }}
                  </div>
                  <div class="nav-card-title">{{ previousGuide.title }}</div>
                  <div class="nav-card-meta">
                    <span v-if="previousGuide.category">{{
                      getCategoryName(previousGuide.category)
                    }}</span>
                ...
                <a
                  v-if="nextGuide"
                  :href="getLocalizedPath(`/vein-guides${nextGuide.addressBar}`)"
    ...
    <section class="guide-content" v-else>
      <div class="container">
        <div class="not-found">
          ...
          <a :href="getLocalizedPath('/vein-guides')" class="btn-hero btn-secondary"
            >Back to Guides</a
          >
        </div>
      </div>
